"""
🎛️ PROCESS MERGED MP3 CONFIGURATION
===================================

This config is specifically for processing merged MP3 files with noise reduction.
Use this when you want to clean up the merged audio files with AI-powered noise removal.

HOW TO USE:
1. Edit the values below to change processing behavior
2. Save the file
3. Run: py process_merged_mp3.py
...
# File naming
OUTPUT_FILE_PREFIX = "sum_"         # Prefix added to cleaned files (e.g., "sum_merged_audio.mp3")
...
ENABLE_NOISE_GATE = False              # False = skip noise gate to preserve all speech
...
if __name__ == "__main__":
    ...
    print("🎛️ Current Process Merged MP3 Configuration:")
    print("=" * 50)
    ...
    print("\n💡 To use this configuration, run: py process_merged_mp3.py")
